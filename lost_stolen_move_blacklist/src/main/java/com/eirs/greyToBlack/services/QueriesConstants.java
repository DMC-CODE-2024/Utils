...
public interface QueriesConstants {
    ...
    String INSERT_INTO_BLACK_LIST_TABLE = "insert into black_list (actual_imei,IMEI,IMSI,MSISDN,OPERATOR_NAME,created_on,TXN_ID,REQUEST_TYPE,SOURCE,remark ) SELECT actual_imei,IMEI,IMSI,MSISDN,OPERATOR_NAME,created_on,TXN_ID,REQUEST_TYPE,SOURCE_OF_REQUEST,CLARIFY_REASON  from  stolen_list_temp";
